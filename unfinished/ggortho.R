...
ggortho <- function(centre.lat, centre.lon,
  ...
  p <- ggplot() +
    ...
    geom_sf_label(data = lat.ax, aes(label = lat.ax.labs), label.size = 0, alpha = 0.75, label.r = unit(0.5, "lines")) +
    geom_sf_label(data = long.ax, aes(label = labs), label.size = 0, alpha = 0.75, label.r = unit(0.5, "lines"))
...
ggortho(centre.lat = 45, centre.lon = 90,
        lat.ax.vals = seq(-90, 90, 30),
        #lat.ax.labs.pos = 60,
        plot.visible = FALSE)


ggortho(centre.lat = 90, centre.lon = 0,
        lat.ax.vals = seq(-90, 90, 30),
        #lat.ax.labs.pos = 60,
        plot.visible = FALSE)
...
ggortho(centre.lat = -30, centre.lon = -120,
        lat.ax.vals = seq(-90, 90, 30),
        #lat.ax.labs.pos = 60,
        plot.visible = FALSE)
