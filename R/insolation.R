...
#'@description Computes daily average insolation as a function of day and
#'  latitude given the orbital parameters.
#'@details Insolation calculation, converted and adapted from the Eisenmann and
...
#' @description Computes the daily average insolation for any time in the last 5 
#' Million years
#' @details Computes the daily average insolation, converted and adapted from 
...
orbital_parameters_fast<-function(kyear){
  if ( length(ecustools::orbital_global$ecc) != 50001) halt("orbital parameters not initalized")
