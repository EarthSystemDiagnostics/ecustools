...
#'
#' @description Probability density function and random generation for seasonal temperatures
#' @details The seasonal temperature cycle is approximated as a sine wave with gaussian noise. 
#' The probability density function is obtained by numerically convoluting a scaled sine wave and normal PDF with mean = 0.
#' Random deviates are generated by adding gaussian noise to points sampled uniformly from the scaled sine wave on the interval
#' 0 to 2*pi
#' @param x vector of temperatures
#' @param mean.t mean annual temperature
#' @param amp.t amplitude of the seasonal cycle
#' @param sd.t inter-annual standard deviation of temperature at a given point in the seasonal cycle
#' @param return return densities for temperatures x, or a function to do so, Default: c("density", "FUN")
#' @param res resolution of the temperature vectors to be convolved, Default: 0.01
#' @name SeasonalCycle
